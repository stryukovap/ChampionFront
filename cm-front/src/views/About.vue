<template>
    <div class="about">
        ...
        <!-- <form action="#">
          ...
          <router-link class="btn btn-primary" to="/restorepassword">Restore</router-link>
        </form> -->
        <form class="popup__edit container text-center">
            <div class="popup__title-wrapper row">
                <h2 class="popup__title col">Edit Sportsman</h2>
...
<script>
    ...
    export default {
        ...
        methods: {
            updateSportsman: function () {
                window.console.log("You push button Save");
            },
            closePopup: function () {
                window.console.log("You push button Close");
            }
        }
    }
</script>
